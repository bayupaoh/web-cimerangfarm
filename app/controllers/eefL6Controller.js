(function(){
  ...
  angular
    ...
    .controller('eefL6Controller', eefL6Controller);

  function eefL6Controller() {
    var vm = this;
    var tanggal   = [];
    var nilaiEef  = [];
    var standarEef = [
    ...
    var refSetting = firebase.database().ref('grafik/kandang6/setting');
    var refPakan = firebase.database().ref('grafik/kandang6/feedandmortality');
