(function(){
  ...
  angular
    ...
    .controller('mortalityL5Controller', mortalityL5Controller);

  function mortalityL5Controller() {
    var vm = this;
    var tanggal = [];
    ...
    var refMortality = firebase.database().ref('grafik/kandang5/feedandmortality');
