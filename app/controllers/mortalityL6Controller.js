(function(){
  ...
  angular
    ...
    .controller('mortalityL6Controller', mortalityL6Controller);

  function mortalityL6Controller() {
    var vm = this;
    var tanggal = [];
    ...
    var refMortality = firebase.database().ref('grafik/kandang6/feedandmortality');
